...
echo "rtp_frame_aware,fec_k,fec_n,loss,rep,packets_sent,packets_recv,frames_complete_rate,tail_p50_us,tail_p95_us,tail_p99_us,wire_amplification,rx_fec_recovered,rx_lost,tx_frame_closures" > "$summary"
...
row = [aware, k, n, loss, rep,
       ...
       m['rx_fec_recovered'], m['rx_lost'], m['tx_frame_closures']]
